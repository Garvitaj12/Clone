...
cart.forEach((cartItem) => {
    ...
    cartSummaryHTML = cartSummaryHTML + `<div class="cart-item-container js-cart_item_container_${matchingProduct.id}">
...
document.querySelectorAll('.js_delete_link').forEach((link) => {
  link.addEventListener('click', () => {
    ...
    const container = document.querySelector(`.js-cart_item_container_${productId}`);
    container.remove();
  });
});
